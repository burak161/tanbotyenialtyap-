...
client.on("ready", () => {
  ...
  client.user.setActivity('edited by pїятчч | -yardım');
})
...
client.login(ayarlar.token);
  ...
  client.on("ready", () => {
  client.channels.cache.get("849806922898735145").join();//sesli bi kanala katılacagı icin kanal ID si
}) 
...
.addField("Sunucudaki Kişi Sayısı:", guild.memberCount)
   ...
   client.channels.get('977734077736165376').send(rrrsembed);
